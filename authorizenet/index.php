            ...
            <tr>
				...
				<td colspan="2"><b><font size="2"color="#ff0000">* </font>Donation Amount:</b>&nbsp;<input type="text" name="UMamount" id="AmountId" value="0.00" onblur="addDotToAmount();"></td>
                            ...
                            <tr>
                                ...
                                <input type="checkbox" name="purpose" value="$360 per seat - Non Members-High Holiday Seats for both Rosh Hashana &#038; Yom Kippur" id="hhry" onclick="addqty('hhry', 'hhry_qty_id')" disabled=""> $360 per seat - Non Members-High Holiday Seats for both Rosh Hashana &#038; Yom Kippur  --- Quantity: <input type="text" name="hhry_qty" id="hhry_qty_id" value="0" maxlength="2" size="2"><br />
                                <input type="checkbox" name="purpose" value="$180 per seat - Non Members-High Holiday Seats-Rosh Hashana" id="hhr" onclick="addqty('hhr', 'hhr_qty_id')" disabled=""> $180 per seat - Non Members-High Holiday Seats-Rosh Hashana  --- Quantity: <input type="text" name="hhr_qty" id="hhr_qty_id" value="0" maxlength="2" size="2"><br />
                                <input type="checkbox" name="purpose" value="$180 per seat - Non Members-High Holiday Seats-Yom Kippur" id="hhy" onclick="addqty('hhy', 'hhy_qty_id')" disabled=""> $180 per seat - Non Members-High Holiday Seats-Yom Kippur  --- Quantity: <input type="text" name="hhy_qty" id="hhy_qty_id" value="0" maxlength="2" size="2"><br />
