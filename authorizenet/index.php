            ...
            <tr>
				...
				<td colspan="2"><b><font size="2"color="#ff0000">* </font>Donation Amount:</b>&nbsp;<input type="text" name="UMamount" id="AmountId" value="0.00" onblur="addDotToAmount();"></td>
                            ...
                            <tr>
                                ...
                                <input type="checkbox" name="purpose" value="$260 per seat - Non Members-High Holiday Seats-Yom Kippur" id="hhy" onclick="addqty('hhy', 'hhy_qty_id')" disabled="disabled"> $260 per seat - Non Members-High Holiday Seats-Yom Kippur --- Quantity: <input type="text" name="hhy_qty" id="hhy_qty_id" value="0" maxlength="2" size="2"><br />
